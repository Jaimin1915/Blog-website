            ...
            <div className='px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-4'>
                <div>
                    <div className='grid grid-cols-2 gap-5 lg:col-span-4 md:grid-cols-6'>
                        <div>
                            <p className='font-meduim tracking-wide text-gray-300'>Category</p>
                        ...
                        <div>
                            <p className='font-meduim tracking-wide text-gray-300'>Apples</p>
                            <ul className='mt-2 space-y-2'>
                                <li>
                                    <a href='/' className='text-gray-500 transition-colors duration-300
                        ...
                        <div>
                            <p className='font-meduim tracking-wide text-gray-300'>Cherry</p>
                            <ul className='mt-2 space-y-2'>
                                <li>
                                    <a href='/' className='text-gray-500 transition-colors duration-300
                        ...
                        <div>
                            <p className='font-meduim tracking-wide text-gray-300'>Business</p>
                            <ul className='mt-2 space-y-2'>
                                <li>
                                    <a href='/' className='text-gray-500 transition-colors duration-300
                        ...
                        <div className='md:max-w-md lg:col-span-2 lg:mt-0 mt-5'>
                            <p className='font-meduim tracking-wide text-gray-300'>Subscribe for updates </p>
                            <form className='mt-4 flex flex-col md:flex-row'>
                                ...
                                <button type='submit' className='inline-flex item-center justify-center h-12 px-6
                                    font-medium tracking-wide text-white transition duration-200 rounded
                                    shadow-md hover:bg-orange-500 focus:outline-none border pt-2'> Subscribe
                                </button>
                            </form>
                        </div>
                    </div>

                    <div className='text-white flex flex-col justify-between pt-5 pb-10 border-t border-gray-800 sm:flex-row'>
